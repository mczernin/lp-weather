...
(function( $, undefined ) {
  ...
  $.widget( "ui.addresspicker", {
    options: {
        ...
        mapOptions: {
            zoom: 10, 
            center: new google.maps.LatLng(51.51833011190175,-0.07066657712402957), 
            scrollwheel: false,
    ...
    _create: function() {
      ...
      this.lat_in      = $(this.options.elements.lat_in);
      this.lng_in      = $(this.options.elements.lng_in);
    ...
    _updatePosition: function(location) {
      if (this.lat) {
        ...
        this.lat_in.val(location.lat());
        
      }
      if (this.lng) {
        this.lng.val(location.lng());
        this.lng_in.val(location.lng());
